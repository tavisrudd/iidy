...
impl Commands {
    ...
    pub fn to_cfn_operation(&self) -> crate::cfn::CfnOperation {
        match self {
            ...
            Commands::LintTemplate(_) => crate::cfn::CfnOperation::LintTemplate,
...
pub struct RenderArgs {
    ...
    #[arg(
        long,
        default_value = "yaml",
        help = "Output format: yaml, json, or yaml-cloudformation"
    )]
    pub format: String,
    #[arg(long)]
    pub query: Option<String>,
...
mod tests {
    ...
    fn aws_opts_normalize_preserves_user_provided_token() {
        ...
        assert!(matches!(
            ...
            crate::aws::client_req_token::TokenSource::UserProvided
        ));
    ...
    fn aws_opts_normalize_generates_token_when_none_provided() {
        ...
        assert!(matches!(
            normalized.client_request_token.source,
            crate::aws::client_req_token::TokenSource::AutoGenerated
        ));
        assert!(normalized.fixture_set.is_none());
    }
    ...
    fn aws_opts_normalize_generates_unique_tokens() {
        ...
        assert_ne!(
            normalized1.client_request_token.value,
            normalized2.client_request_token.value
        );
        assert_ne!(
            normalized1.client_request_token.operation_id,
            normalized2.client_request_token.operation_id
        );
    }
