...
impl ErrorId {
    ...
    pub fn in_category(category_num: u16) -> Vec<ErrorId> {
        ...
        let all_errors = [
            ErrorId::InvalidYamlSyntax,
            ErrorId::YamlVersionMismatch,
            ErrorId::UnsupportedYamlFeature,
            ErrorId::MalformedYamlStructure,
            ErrorId::YamlMergeKeyUsage,
            ErrorId::VariableNotFound,
            ErrorId::VariableNameCollision,
            ...
            ErrorId::ImportCircularDependency,
            ErrorId::ImportFormatNotSupported,
            ErrorId::EnvironmentVariableNotFound,
            ErrorId::GitCommandFailure,
            ErrorId::S3AccessDenied,
            ErrorId::SsmParameterNotFound,
            ...
            ErrorId::IncompatibleTagCombination,
            ErrorId::TagSyntaxError,
            ErrorId::TypeMismatchInOperation,
            ErrorId::InvalidArrayOperation,
            ErrorId::InvalidObjectOperation,
            ErrorId::DivisionByZero,
            ErrorId::InvalidComparison,
            ErrorId::StringOperationOnNonString,
            ErrorId::HandlebarsSyntaxError,
            ErrorId::UnknownHandlebarsHelper,
            ErrorId::HandlebarsHelperArgumentError,
            ErrorId::TemplateCompilationFailure,
            ErrorId::TemplateExecutionError,
            ErrorId::InvalidCloudFormationIntrinsic,
            ErrorId::CloudFormationReferenceError,
            ErrorId::CloudFormationDependencyIssue,
            ErrorId::CloudFormationTemplateSizeLimit,
            ErrorId::InvalidCommandLineArgument,
            ErrorId::MissingRequiredConfiguration,
            ErrorId::ConfigurationFileNotFound,
            ErrorId::AwsCredentialsNotConfigured,
            ErrorId::UnsupportedFileFormat,
            ErrorId::InternalProcessingError,
            ErrorId::MemoryAllocationFailure,
            ErrorId::FileSystemPermissionDenied,
            ErrorId::NetworkConnectivityIssue,
            ErrorId::UnexpectedSystemError,
        ];
...
mod tests {
    ...
    fn test_error_id_categories() {
        ...
        assert_eq!(
            ErrorId::HandlebarsSyntaxError.category(),
            "Template & Handlebars"
        );
    }
