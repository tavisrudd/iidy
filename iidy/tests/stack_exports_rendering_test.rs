...
async fn test_stack_exports_with_importing_stacks() {
    ...
    let stack_contents = StackContents {
        ...
        exports: vec![
            StackExportInfo {
                ...
                exporting_stack_id: "arn:aws:cloudformation:us-east-1:123456789012:stack/leixir-api/id".to_string(),
    ...
    renderer.render_output_data(OutputData::StackContents(stack_contents), None).await
    ...
    let stack_contents = StackContents {
        ...
        exports: vec![
            StackExportInfo {
                ...
                exporting_stack_id: "arn:aws:cloudformation:us-east-1:123456789012:stack/shared-stack/id".to_string(),
