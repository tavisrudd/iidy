...
mod tests {
    ...
    fn token_derivation_is_deterministic() {
        let primary = TokenInfo::user_provided("abc123ef-4567-89ab-cdef-0123456789ab".to_string(), "op-1".to_string());
    ...
    fn derived_token_properties() {
        let primary = TokenInfo::user_provided("test-primary-token".to_string(), "op-1".to_string());
