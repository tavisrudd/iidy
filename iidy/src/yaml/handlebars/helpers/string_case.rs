...
use heck::{ToKebabCase, ToSnakeCase, ToLowerCamelCase, ToUpperCamelCase, ToTitleCase};
...
pub fn pascal_case_helper(
    ...
    let string_value = value.as_str()
        .ok_or_else(|| handlebars::RenderError::new("pascalCase helper requires a string parameter"))?;
