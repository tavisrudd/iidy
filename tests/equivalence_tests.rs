...
mod scalar_equivalence_tests {
    ...
    async fn test_complex_scalar_cases() -> Result<()> {
        let cases = vec![
            ...
            (
                ...
                Value::String("hello-world_test.example".to_string()),
            ),
            ...
            (
                "small_float",
                Value::Number(serde_yaml::Number::from(0.000001)),
            ),
            (
                "scientific_notation",
                Value::Number(serde_yaml::Number::from(1.23e10)),
            ),
    ...
    async fn test_edge_cases() -> Result<()> {
        let edge_cases = vec![
            ...
            (
                "string_that_looks_like_number",
                Value::String("123".to_string()),
            ),
            (
                "string_that_looks_like_null",
                Value::String("null".to_string()),
            ),
            (
                "string_that_looks_like_bool",
